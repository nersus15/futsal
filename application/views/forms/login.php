          ...
          <div class="row">
            ...
            <div class="col-md-6">
              <div class="oblique position-absolute top-0 h-100 d-md-block d-none me-n8" style="width: 125%">
                <div class="oblique-image bg-cover position-absolute fixed-top ms-auto h-100 z-index-0 ms-n6" style="background-image:url('<?= base_url('public/assets/img/sideImage/l1.jpg') ?>')"></div>
              </div>
            </div>
          </div>
        </div>
